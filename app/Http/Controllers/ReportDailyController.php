        ...
        foreach ($data_offline as $item) {
            ...
            foreach ($metrics as $label => $key) {
                switch ($key) {
                    ...
                    case 'sr_total_potential': $totals_current[$item->showroom_id][$key] += (int) $item->old_potential; break;
            ...
            if (isset($sourceIdToShowroomId[$item->source_id])) {
                ...
                foreach ($metrics as $label => $key) {
                    switch ($key) {
                        ...
                        case 'sr total_potential': $totals_current[$showroom_id][$key] += (int) $item->old_potential; break;
        ...
        foreach ($data_offline_prev as $item) {
            foreach ($metrics as $label => $key) {
                switch ($key) {
                    ...
                    case 'sr_total_potential': $totals_prev[$item->showroom_id][$key] += (int) $item->old_potential; break;
            ...
            if (isset($sourceIdToShowroomId[$item->source_id])) {
                ...
                foreach ($metrics as $label => $key) {
                    switch ($key) {
                        ...
                        case 'sr_total_potential': $totals_prev[$showroom_id][$key] += (int) $item->old_potential; break;

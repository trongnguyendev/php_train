...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $customer = Customer::create([
            ...
            'zalo_feedback' => $request->zaloFeedback,
            'type_customer_yet_id' => $request->type_customer,
            'type_customer_id' => $request->type_customer,
            'type_showroom_id' => $request->page_source,
            'type_category_id' => $request->sale_product,
            'status_first_id' => $request->first_guest_status,
            'note_sale' => $request->note,
            'salename_infor_id' => $request->sale_infor,
            'salename_support_id' => $request->current_guest_status,
            'current_status_id' => $request->information_exchange,
            'order_value' => $request->results,
            'customer_support_yet_id' => $request->take_care_guest_first_one,
        ]);

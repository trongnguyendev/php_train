...
return new class extends Migration
{
    ...
    {
        Schema::create('leadOnlines', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('first_care_date');
            $table->text('result1');
            $table->date('two_care_date');
            $table->text('result2');
            $table->date('three_care_date');
            $table->text('result3');
            $table->timestamps();
        });
    ...
    {
        Schema::dropIfExists('leadOnlines');
    }
};

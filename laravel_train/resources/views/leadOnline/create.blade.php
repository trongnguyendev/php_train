    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card fade-in">
                ...
                <div class="card-body">
                    <form action="{{ route('leadonline.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="result1" id="result1" class="form-control" value="{{ old('result1') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="result2" id="result2" class="form-control" value="{{ old('result2') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="result3" id="result3" class="form-control" value="{{ old('result3') }}">
                            </div>
                        </div>

...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('leadonline.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('leadonline.index') }}" method="GET" class="row g-3">
                <div class="col-md-4">
            ...
            <table class="table table-bordered table-striped align-middle">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th>Kế hoạch lần 1</th>
                        <th>Ngày sẽ chăm khách lần 2</th>
                        <th>Kế hoạch lần 2</th>
                        <th>Ngày sẽ chăm khách lần 3</th>
                        <th>Kế hoạch lần 3</th>
                        <th>Thời Gian Tạo</th>
                        <th class="text-center">Hành động</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($leadonline as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('leadonline.show', $item->id) }}" class="btn btn-sm btn-info">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('leadonline.edit', $item->id) }}" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="{{ route('leadonline.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Bạn có chắc muốn xóa?')">
                                    @csrf
                                    @method('DELETE')

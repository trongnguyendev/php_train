...
//     }
    ...
    class Export_items extends Model {
        ...
        public function getInfoImport($idReceipt, $columnSelection = []) {
                ...
                $sql = "
                    ...
                    INNER JOIN export_receipts ON export_receipts.id = {$this->table}.export_receipt_id
                    INNER JOIN warehouses ON warehouses.id = export_receipts.warehouse_id
                    WHERE {$this->table}.export_receipt_id = {$idReceipt}
                ";

...
@section('content')
@can('viewAny', App\Models\CustomerSource::class)
...
@endcan
@cannot('viewAny', App\Models\CustomerSource::class)
<div class="container-fluid">
    <div class="alert alert-danger">
        <i class="bi bi-exclamation-triangle"></i> Bạn không có quyền xem danh sách Phân loại khách hàng
    </div>
</div>
@endcannot
@endsection
